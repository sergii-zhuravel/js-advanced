...
function makeAdder(num) {
  //!! Нельзя назьівать переменньіе словами похожими на зарезервированньіе
...
Dancer.prototype.dance = function() {
  console.log(
    "My name is " + this.name + ".I am a " + this.danceStyles + " dancer."
  );
};
...
//!!! функция могла бьіть у родителя Dancer
