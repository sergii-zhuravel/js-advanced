...
Animal.prototype = { constructor: Animal }; /// !!! єтот код ненужен
...
Animal.prototype.toDie = function() {
  this.alive = false;
};
...
/// !!! Ответ:
/// Потому что Animal єто функция, у нее прототип Animal.__proto__  ведет на Function.prototype
///  new Animal() или Object.create(new Animal()) - єто єкземплярьі обьекта и у них другой прототайп чейн

// Второй уровень наследования
Bird.prototype = Object.create(new Animal());

Bird.prototype.getFeathersColor = function() {
  return this.feathersColor;
};
Bird.prototype.setFeathersColor = function(color) {
  this.feathersColor = color;
};
Bird.prototype.isAbleSweem = function() {
  return this.canSweem;
};
...
Mammal.prototype.getMaxAge = function() {
  return this.maxAge;
};
Mammal.prototype.getBodyTemperature = function() {
  return this.bodyTemperature;
};
Mammal.prototype.isHerbivore = function() {
...
Cat.prototype.getHairColor = function() {
  return this.hairColor;
};
Cat.prototype.isCute = function() {
  return this.cute;
};
